...
plugins=(git python pyenv docker docker-compose history-substring-search per-directory-history per-directory-history-patch)

# per-directory-history config
HISTORY_BASE=~/.oh-my-zsh/history
PER_DIRECTORY_HISTORY_TOGGLE=^H
PER_DIRECTORY_HISTORY_DEFAULT_GLOBAL=true
